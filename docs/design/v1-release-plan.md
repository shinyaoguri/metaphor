...
- [ ] **既知の設計上の宿題が片付いている**(2026-08-13 差し替え — 旧条件「0.9 系で breaking なしの実績」は凍結撤回により判定材料にならなくなった。ADR-0009)。昇格時点で open な API 設計課題がゼロであること。現時点の中身 = #322 フェーズ 2(旧名削除)/ #519・#523・#504(Processing 互換の意味論)/ #339(契約フリーズ点・旧 W4-2)
