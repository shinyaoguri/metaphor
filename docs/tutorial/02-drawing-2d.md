...
![文字の見本が 1 枚に。大きな「metaphor」の見出し、日本語、中央揃えと右揃え、Helvetica と Courier、傾けた文字](https://i.gyazo.com/823f4b486d779bd5263c5f0325eccb9e.png)
...
長い文章は、矩形を渡して折り返す `text(_:_:_:_:_:)` に流し込めます（幅で自動的に改行されます）。この節のスケッチでは扱っていません。
