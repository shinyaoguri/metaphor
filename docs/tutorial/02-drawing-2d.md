...
![上の段に円・楕円・矩形・角丸の矩形、下の段に三角形・四角形・扇形・線と点が、白い輪郭の青い図形として並んでいる](https://i.gyazo.com/1d286c3fedc35f2a80da9a3afcf5bcae.png)
...
![色の帯が 4 段。赤・緑・青の原色、アルファを重ねた 3 色、虹色に刻んだ階調、オレンジから青へ滑らかに変わるグラデーション](https://i.gyazo.com/cab140ec0cc720385a20be27b723cb4d.png)
...
![太さを変えた線の束、端の処理（キャップ）を変えた 3 本の帯、角のつなぎ方（ジョイン）を変えた 3 つの山形](https://i.gyazo.com/0a26b2061ea56d8d798a19a1e44273ea.png)
...
- 7 の `curveTightness` に `-3` や `3` を渡すと、曲線はどこまで暴れますか（`-5` 〜 `5` が目安です。範囲外も渡せますが、曲線は制御点から大きく外れます）
...
![赤い四角、45 度傾いた水色の四角、横に伸ばした黄色い四角と、push / pop を入れ子にして描いた灰色の腕](https://i.gyazo.com/7e1ce8fa7f7ced75cbacecf707b11a21.png)
...
![小さな四角を格子状に並べた模様。右へ行くほど傾きが強くなり、色が青から紫・オレンジへ移っていく](https://i.gyazo.com/77c4506eca00ce2d6764df35063fe66d.png)
...
![文字の見本が 1 枚に。大きな「metaphor」の見出しとベースラインの線、日本語、中央揃えと右揃え、Helvetica と Courier、傾けた文字、左下に幅で折り返した 2 行の英文](https://i.gyazo.com/54c50faa3efe40769f721fd9e4040816.png)
...
- 折り返しの `text(..., 40, 305, 260, 44)` の幅 260 を 120 にすると、文章は何行になりますか
...
![同じ画像を 5 通りに描いている。原寸、中心を基準に置いたもの、青く色を乗せたもの、半透明で 2 枚重ねたもの](https://i.gyazo.com/3e12ef11d5ab81943e5cdde879f0d872.png)
...
![横一列に重なった水色の円。画面中央の白い縦線から右側だけが、画素を書き換えてグレースケールになっている](https://i.gyazo.com/19b6cccb4ce07498ea8a70e415742458.png)
...
![赤・緑・青の円を重ねた組を 4 つ並べ、alpha / additive / multiply / screen の混ざり方を比べている](https://i.gyazo.com/5535f0dc11628413fe95d2194ab1d893.png)
