...
final class Mixture: Sketch {
    ...
    func draw() {
        ...
        pointLight(200, -150, 0, color: Color(r: 150.0/255, g: 100.0/255, b: 0), falloff: 0)
        directionalLight(1, 0, 0, color: Color(r: 0, g: 102.0/255, b: 1.0))
        spotLight(0, 40, 200, 0, -0.5, -0.5, angle: Float.pi / 2, falloff: 0, color: Color(r: 1.0, g: 1.0, b: 109.0/255))
