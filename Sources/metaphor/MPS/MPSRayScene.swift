...
final class MPSRayScene {
    ...
    func buildAccelerationStructure() throws -> (
        ...
        guard !entries.isEmpty else {
            throw MPSError.invalidScene("No meshes added to scene")
        }
        ...
        guard let vertexBuffer = device.makeBuffer(
            ...
            throw MPSError.accelerationStructureBuildFailed("Failed to create vertex buffer")
        }
        ...
        guard let indexBuffer = device.makeBuffer(
            ...
            throw MPSError.accelerationStructureBuildFailed("Failed to create index buffer")
        }
        ...
        guard let normalBuffer = device.makeBuffer(
            ...
            throw MPSError.accelerationStructureBuildFailed("Failed to create normal buffer")
        }
